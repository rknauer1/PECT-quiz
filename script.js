const questions = [
    // NFPA 96 Standards
    {
        ...
        [cite_start]explanation: "NFPA 96 requires the system to be cleaned if found to be contaminated with grease deposits. [cite: 157] [cite_start]An accumulation of 0.08 inches (approx. 2000 microns) is well above the 50-micron cleaning threshold. [cite: 149]"
    },
    {
        ...
        [cite_start]explanation: "An exhaust system must be cleaned, at a minimum, to remove combustible contaminants down to a depth of 0.002 inches or 50 microns. [cite: 149]"
    },
    {
        ...
        [cite_start]explanation: "According to NFPA 96, systems serving high-volume cooking operations like wok cooking require monthly inspections. [cite: 155]"
    },
    {
        ...
        [cite_start]explanation: "Systems with low-volume cooking, such as those in churches, must be inspected at least annually. [cite: 401]"
    },
    {
        ...
        [cite_start]explanation: "Kitchen exhaust systems serving moderate-volume cooking establishments must be inspected for cleanliness semiannually. [cite: 143]"
    },
    {
        ...
        [cite_start]explanation: "NFPA 96 mandates that systems serving solid fuel cooking operations be inspected monthly. [cite: 100]"
    },
    {
        ...
        [cite_start]explanation: "NFPA 96 states that during a cleaning or inspection, all interior surfaces of the entire exhaust system shall be accessible. [cite: 72, 85]"
    },
    {
        ...
        [cite_start]explanation: "The use of gasoline or other flammable solvents is not acceptable under any circumstance for cleaning a kitchen exhaust system due to the extreme fire hazard. [cite: 78, 377]"
    },
    {
        ...
        [cite_start]explanation: "When affixing a new certificate or sticker, the technician must remove any old certificates to avoid confusion about the system's service status. [cite: 224]"
    },
    {
        ...
        [cite_start]explanation: "The proper orientation of the baffles in a filter is vertical to facilitate the capture and drainage of grease. [cite: 90]"
    },
    {
        ...
        [cite_start]explanation: "To ensure structural integrity and fire resistance, grease ducts made of carbon steel must be at least 16 MSG in thickness. [cite: 408]"
    },
    {
        ...
        [cite_start]explanation: "Grease ducts are required to be liquid-tight, which is achieved with continuous external welding on all seams and joints to prevent grease leakage. [cite: 380]"
    },
    {
        ...
        [cite_start]explanation: "NFPA 96 requires all combustible materials to be a minimum of 18 inches away from the exhaust ductwork to prevent ignition in case of a duct fire. [cite: 119]"
    },
    {
        ...
        [cite_start]explanation: "It is not permissible to have access panels on the bottom of a duct because they can leak grease and present a fire hazard. [cite: 382]"
    },
    {
        ...
        [cite_start]explanation: "The edge of an access panel opening in a horizontal, non-listed duct must be at least 1.5 inches from all edges or welded seams of the duct to maintain structural integrity. [cite: 170, 409]"
    },
    {
        ...
        [cite_start]explanation: "NFPA 96 requires that access be provided within 3 feet of both sides of an in-line fan to allow for proper cleaning of the fan blades and housing. [cite: 132, 400]"
    },
    {
        ...
        [cite_start]explanation: "An upblast exhaust fan shall be provided with a grease receptacle that does not exceed 1 gallon in size to prevent large accumulations of grease on the roof. [cite: 207]"
    },
    {
        ...
        [cite_start]explanation: "A hold-open retainer is required on the hinge assembly of an upblast fan to prevent the fan from accidentally closing on a technician during service. [cite: 201]"
    },
    {
        ...
        explanation: "Fusible links are sensitive heat-activated devices. [cite_start]They must be protected from chemicals or physical damage during cleaning, as this could impair their function or cause premature activation. [cite: 62, 376]"
    },
    {
        ...
        [cite_start]explanation: "Waste should be disposed of in the manner prescribed by the Authority Having Jurisdiction (AHJ), which is typically a sanitary drain that leads to a water treatment facility. [cite: 235, 402]"
    },
    {
        ...
        [cite_start]explanation: "NFPA 96 defines 'shall' as indicating a mandatory requirement that must be followed. [cite: 240]"
    },
    {
        ...
        [cite_start]explanation: "The fire triangle illustrates the three essential components needed for combustion: heat (ignition source), oxygen, and a fuel source (like grease). [cite: 396]"
    },
    // OSHA Standards
    {
        ...
        [cite_start]explanation: "OSHA requires that when a portable ladder is used for access, its side rails must extend at least 3 feet above the upper landing surface to provide a secure handhold. [cite: 288]"
    },
    {
        ...
        [cite_start]explanation: "OSHA requires ladders to be inspected for visible defects periodically and always after any occurrence which could affect their safe use. [cite: 275]"
    },
    {
        ...
        [cite_start]explanation: "With very limited exceptions, OSHA mandates that each lockout or tagout device must be removed by the employee who applied it. [cite: 315]"
    },
    {
        ...
        [cite_start]explanation: "Prior to starting work, the authorized employee must verify that the machine has been properly de-energized, for instance by attempting to activate the normal operating controls. [cite: 265]"
    },
    {
        ...
        explanation: "A respirator is an example of PPE, which is equipment worn to minimize exposure to hazards. [cite_start]Other examples include gloves, goggles, and steel-toed boots. [cite: 337, 391]"
    },
    {
        ...
        [cite_start]explanation: "Due to the high risk of chemical splashes that can cause severe eye damage, splash-proof safety goggles are required when working with caustic degreasers. [cite: 309]"
    },
    {
        ...
        [cite_start]explanation: "OSHA's Hazard Communication Standard requires that employees must be trained on the hazards of chemicals before they are exposed to them in the workplace. [cite: 252]"
    },
    {
        ...
        [cite_start]explanation: "SDS stands for Safety Data Sheet, which is a standardized document containing detailed information about a hazardous chemical's properties and risks. [cite: 388]"
    },
    {
        ...
        [cite_start]explanation: "OSHA requires that an employee be fit-tested for their specific tight-fitting respirator at least annually to ensure a proper seal. [cite: 292]"
    },
    {
        ...
        [cite_start]explanation: "A confined space is defined by OSHA as having limited means of entry or exit and not being designed for continuous human occupancy; many duct systems meet this definition. [cite: 323]"
    },
    {
        ...
        [cite_start]explanation: "For any permit-required confined space entry, at least one attendant (or safety watch) must be posted outside to monitor the entrant and summon help if needed. [cite: 330]"
    },
    {
        ...
        [cite_start]explanation: "To prevent back injuries, which are common, you should always lift heavy objects by bending your knees and using the power of your legs, keeping your back straight. [cite: 370]"
    },
    // Acronyms
    {
        ...
        [cite_start]explanation: "IKECA is the International Kitchen Exhaust Cleaning Association, the organization that provides the PECT designation and sets industry standards. [cite: 1, 3, 5, 387]"
    },
    {
        ...
        [cite_start]explanation: "OSHA is the Occupational Safety and Health Administration, the U.S. government agency responsible for setting and enforcing workplace safety standards. [cite: 81, 389]"
    },
    {
        ...
        [cite_start]explanation: "The AHJ is the entity, most often the local fire marshal, responsible for interpreting and enforcing code compliance for fire and life safety. [cite: 80, 384]"
    },
    {
        ...
        [cite_start]explanation: "The EPA, or Environmental Protection Agency, has regulations (like the Clean Water Act) that govern the proper disposal of wastewater and chemicals used during cleaning. [cite: 390]"
    },
    {
        ...
        [cite_start]explanation: "Technicians primarily clean Type I hoods, which are designed to handle grease-laden vapors from commercial cooking, as opposed to Type II hoods which handle heat and moisture only. [cite: 394]"
    }
    {
        ...
        [cite_start]explanation: "Upon completion, the technician must ensure all electrical switches and system components, including the fan, are returned to a safe and operable state[cite: 220, 221]."
    },
    {
        ...
        [cite_start]explanation: "Installing filters at a minimum 45-degree angle ensures that collected grease drains properly into the drip tray, preventing grease from dripping onto cooking surfaces[cite: 374]."
    },
    {
        ...
        [cite_start]explanation: "While specific overhangs are often required by local codes, the primary NFPA 96 requirement is that the hood shall be sized to effectively capture the grease-laden vapors from the cooking appliances below[cite: 109]."
    },
    {
        ...
        [cite_start]explanation: "To provide adequate fire resistance and structural integrity, grease ducts made of stainless steel shall be at least 18 MSG (Manufacturer's Standard Gage) in thickness[cite: 408]."
    },
    {
        ...
        [cite_start]explanation: "On vertical ductwork where personnel entry isn't possible, access must be provided on every floor, with openings no more than 12 feet apart, to ensure the entire duct can be reached for cleaning[cite: 163, 164]."
    },
    {
        ...
        [cite_start]explanation: "When a duct is too small for personnel entry, NFPA 96 requires that openings large enough to permit thorough cleaning must be installed at a maximum distance of every 12 feet[cite: 177]."
    },
    {
        ...
        [cite_start]explanation: "To allow for cleaning of the fan's interior, upblast fans must have a rectangular access opening of at least 3x5 inches on the curvature of the fan housing[cite: 195]."
    },
    {
        ...
        [cite_start]explanation: "NFPA 96 stipulates that exhaust fans shall operate whenever the cooking equipment is turned on to ensure grease-laden vapors are properly ventilated[cite: 184]."
    },
    {
        ...
        [cite_start]explanation: "A service company label must be affixed on or near each access panel that has been opened or installed to provide a record of service[cite: 231]."
    },
    {
        ...
        [cite_start]explanation: "To maintain the integrity of the duct during a fire, access panel gaskets must be both greasetight and rated for 1500°F[cite: 397, 398]."
    },
    {
        ...
        [cite_start]explanation: "While cleaners shall not render a system inoperable[cite: 64], discovering an already inoperable system is a major life safety hazard that requires immediate notification to the owner and shutdown of the cooking line."
    },
    {
        ...
        [cite_start]explanation: "Unlike the word 'shall', the word 'should' indicates a recommendation or something that is advised as a best practice but is not mandatory[cite: 247]."
    },
    {
        ...
        [cite_start]explanation: "To ensure stability and prevent falls, OSHA requires users to face the ladder [cite: 277] and maintain three points of contact (two feet and one hand, or one foot and two hands) when climbing."
    },
    {
        ...
        [cite_start]explanation: "When a lockout/tagout tag cannot be directly attached, it must be placed in a position that will be immediately obvious to anyone attempting to operate the device[cite: 261]."
    },
    {
        ...
        [cite_start]explanation: "OSHA's Hazard Communication standard requires that employees have access to a Safety Data Sheet for the chemicals they work with within their same work shift upon request[cite: 296]."
    },
    {
        ...
        [cite_start]explanation: "OSHA defines entry into a confined space as occurring as soon as any part of the entrant's body breaks the plane of the opening into that space[cite: 302]."
    },
    {
        ...
        [cite_start]explanation: "You should protect your hearing by wearing appropriate ear protection when exposed to high noise levels from equipment like power washers to prevent long-term hearing loss[cite: 379]."
    },
    {
        ...
        [cite_start]explanation: "Lockout devices must be identifiable, meaning they must indicate the name of the employee who applied the device[cite: 334]."
    },
    {
        ...
        [cite_start]explanation: "The fan discharge must be at least 40 inches above the roof surface to ensure proper dispersal of exhaust and prevent grease from damaging the roof[cite: 395]."
    },
    {
        ...
        [cite_start]explanation: "NFPA 96 states that if the covering or enclosure of a duct is damaged, you shall repair and restore it to meet its intended listing[cite: 134]."
    },
       {
    ...
    },
    {
        ...
        "options": ["A. Attempt to repair the components themselves.", "B. Proceed with the cleaning and note the issue on the report.", "C. Immediately disable the cooking appliances and notify the owner.", "D. Cover the components to protect them from water during cleaning."],
        "correctAnswer": "C. Immediately disable the cooking appliances and notify the owner.",
        explanation: "While fire suppression components shall not be rendered inoperable by the cleaning crew[cite: 109], if they are found to be inoperable, it is a life safety hazard that requires immediate notification and shutdown of the cooking line."
    },
    {
        "question": "What is the proper procedure for handling fusible links during a cleaning?",
        "options": ["A. Spray them directly with degreaser to clean them.", "B. Remove them before cleaning and reinstall them after.", "C. Cover and protect them from chemicals and pressure washing.", "D. Test their function by applying heat."],
        "correctAnswer": "C. Cover and protect them from chemicals and pressure washing.",
        explanation: "Fusible links should be protected from chemicals and cleaning activities that could damage them or cause premature activation; spraying them directly is wrong[cite: 11]."
    },
    {
        "question": "Where should wastewater containing grease and cleaning chemicals be disposed of?",
        "options": ["A. Into the nearest storm drain.", "B. Into a mop sink or sanitary drain as allowed by the AHJ.", "C. Poured onto the gravel area behind the restaurant.", "D. Down the toilet."],
        "correctAnswer": "B. Into a mop sink or sanitary drain as allowed by the AHJ.",
        explanation: "Waste should be disposed of in the manner prescribed by the Authority Having Jurisdiction (AHJ)[cite: 37, 280], which is typically a sanitary drain."
    },
    {
        "question": "In the context of NFPA 96, what does the word 'shall' signify?",
        "options": ["A. A recommendation that is advised but not required.", "B. A suggestion for best practice.", "C. A mandatory and absolute requirement.", "D. An action left to the technician's discretion."],
